...
export const getCardStyles = (
  ...
  const baseStyles = {
    compact: `relative bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-500 p-3 border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 ${baseAnimation} transform-gpu ${styles.perspective1000}`,
    default: `relative group border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 shadow-sm hover:shadow-xl transition-all duration-700 bg-white dark:bg-gray-800 rounded-2xl overflow-hidden ${baseAnimation} transform-gpu ${styles.perspective1000} ${styles.card3d}`,
    detailed: `relative group border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 shadow-lg hover:shadow-xl transition-all duration-700 bg-white dark:bg-gray-800 rounded-2xl overflow-hidden ${baseAnimation} transform-gpu ${styles.perspective1000} ${styles.card3d}`,
    premium: `relative group border border-purple-200 dark:border-purple-700 hover:border-purple-300 dark:hover:border-purple-600 shadow-xl hover:shadow-2xl transition-all duration-700 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-800 dark:via-blue-900/20 dark:to-purple-900/20 rounded-3xl overflow-hidden ${baseAnimation} transform-gpu ${styles.perspective1000} ${styles.card3d} ${styles.backdropBlurCustom}`
  }
